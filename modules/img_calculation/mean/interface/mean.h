 ...
 * The function calculates the mean value of array elements independently for each channel.
 ...
 * channels so that the result can be stored in Scalar.
 * @param[in] mask optional operation mask, if the mask is not empty,
