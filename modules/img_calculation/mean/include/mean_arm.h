...
Scalar.
*/
FCV_API Scalar mean_neon(const Mat& src);
...
*/
FCV_API Scalar mean_neon(const Mat& src, const Mat& mask);
...
*/
FCV_API Scalar mean_neon(const Mat& src, const Rect& rect);

FCV_API void mean_stddev_neon(const Mat& src, Mat& mean, Mat& stddev);
