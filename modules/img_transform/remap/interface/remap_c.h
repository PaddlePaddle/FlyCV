 ...
 * @param[in] inter_type Interpolation method, see @CInterpolationType, currently only support INTER_LINEAR.
 * @param[in] border_method Make border method, see @CBorderType, currently only support BORDER_CONSTANT.
 * @param[in] border_value Value used in case of a constant border
 */

EXTERN_C FCV_API int fcvRemap(
        CMat* src,
        CMat* dst,
        CMat* map1,
        CMat* map2,
